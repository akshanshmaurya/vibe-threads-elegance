    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <motion.div
          ...
          className="mb-8"
        >
          <h1 className="font-playfair text-3xl md:text-4xl font-bold text-navy mb-4">Sale Items</h1>
          <p className="text-gray-600 font-inter">Great deals on premium fashion items</p>
        </motion.div>
